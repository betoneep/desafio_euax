...
{
    public class NovoDocumentoValidacaoCampos : BaseValidacao
    {
        public NovoDocumentoValidacaoCampos(DocumentoDTO dto)
        {
            ...
            if (dto.ReferenciaId == Guid.Empty)
                Erros.Add("Informe a referência do documento.");
